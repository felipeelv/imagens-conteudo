# Imagens de Conteúdo — Colégio Eleve

Repositório de imagens pedagógicas finalizadas (mapas mentais, infográficos, páginas-resumo) usadas nas apostilas do Colégio Eleve. Cada arquivo é a versão final aprovada de uma página de fechamento de capítulo.
...
### Português — Língua Portuguesa (Unidade 4 de cada ano/série)

| Ano/Série | Unidade | Capítulos prontos |
|---|---|---|
| 4º ano EF | Verbos | Cap 1 — Tempos verbais · Cap 2 — Concordância verbal |
| 5º ano EF | Preposições, Interjeições e Conjunções | Cap 1 — Preposições · Cap 2 — Interjeições · Cap 3 — Conjunções |
| 6º ano EF | Adjetivo, Numeral e Coesão | Cap 1 — Adjetivo · Cap 2 — Numeral · Cap 3 — Coesão referencial |
| 7º ano EF | Verbo: Classificação e Modos | Cap 1 — Conceito e classificação dos verbos · Cap 2 — Verbos auxiliares e locuções verbais · Cap 3 — Modo indicativo · Cap 4 — Modo subjuntivo e imperativo |
| 8º ano EF | Introdução à Sintaxe | Cap 1 — Frase, oração e período · Cap 2 — Variação linguística |
| 9º ano EF | Período Composto | Cap 1 — Conjunções e orações coordenadas · Cap 2 — Conjunções e orações subordinadas · Cap 3 — Orações adjetivas |
| 1ª série EM | Estrutura e Formação de Palavras | Cap 1 — Elementos mórficos · Cap 2 — Processos de formação de palavras |
| 2ª série EM | Crase | Cap 1 — Conceito e casos obrigatórios · Cap 2 — Casos proibidos e facultativos |
| 3ª série EM | Orações Subordinadas Adverbiais | Cap 1 — Classificação das orações adverbiais · Cap 2 — Orações adverbiais reduzidas e pontuação |

**Total Português:** 9 anos/séries · 22 capítulos · 22 mapas mentais.

### Ciências (Unidade 4 de cada ano)
...
| 2ª série EM | Genética Mendeliana | Cap 1 — Conceitos Fundamentais · Cap 2 — Primeira Lei de Mendel · Cap 3 — Segunda Lei de Mendel |
...
| 2ª série EM | Pirâmides | Cap 1 — Elementos e Classificação · Cap 2 — Áreas, Volumes e Tronco de Pirâmide |

**Total Geometria:** 6 anos/séries · 20 capítulos · 20 páginas-resumo.
...
- Aspect ratio: 3:4 portrait (A4 vertical), 2K, fundo branco puro — pronto para impressão.
- Conteúdo bíblico (VP) presente como banner/rodapé discreto em todas as páginas.
- **Nunca** aparece texto identificando disciplina, ano, série, unidade ou capítulo na imagem (regra inviolável editorial).

---

Manutenção: Felipe Rosa · `felipe.rosa@colegioeleve.com.br`
